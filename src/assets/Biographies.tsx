export const BIOS = new Map<String, String>([
    ...
    [
        "Andy", `6' clean, just tall enough to be freakish for the average human girl by the standards of her middle school bullies. Saying she walks with purpose is an understatement-- her stride almost reminiscent of a horse's stomping, charging ahead at full speed to wherever it is she's going. She's got a rotund mess of tragically unkempt frizzy red that almost resembles curls plopped on top of her head, drowning a pencil behind her left ear and a pen behind her right, oriented for maximum efficiency of use. Her form is cloaked in a boxy silhouette. She wears a brown leather trench coat-- real, authentic leather, two sizes too big and patterned all over with an excess of creases and wrinkles from use. Beneath it, any arrangement of ill fitted, oversized suits, slacks that are somehow too short and too big, wrinkled button ups, thick sweaters, and mismatched wool socks. Real wool, mind you. And always one of three pairs of shoes-- a brown pair of (real) leather loafers, a pair of black lace-up boots, and a muddy pair of green rainboots bearing the stains and marks of a thousand lab experiments that have never been cleaned off.
She tends to study in her dorm on the Quandrix campus for hours on end, lantern lit til the wee hours of the morning and light streaming out the open window as the cold night air comes in to keep her awake, and smoke frequently billows out in it's stead as she takes her frequent breaks to clear her head(with real brain chemistry altering drugs-- not this new fake shit.) Otherwise, she's bustling between a billion different classes-- frequently spotted mid horse stomp on all the different campus paths, but never spotted outside while still.

She hits the Biblioplex when she's doing base level research and gathering materials-- sprawling out her books over a specific table she's decided is the best table in the library and deciding which ones to check out and which ones she only needs to look at for a little while.

She also is a research assistant, typically at either the Arithmodrome or the Cultivarium, where she will not hesitate even a little to openly criticize or tell off any of her coworkers who's laziness, incompetence, or existence makes her life more difficult.

She goes to the Bow's End every Friday night, or after a big exam, and downs 5 (craft) beers within 2 hours as she assembles her next week's plans and sorts away her notes into her loosely organized folders-- yes, at the tavern. Because while she unwinds and gets her head proper on her shoulders, she can idly people-watch either the wait staff or the clientele.

She's in the speech and debate club and is also a member of the Strixhaven Star newspaper.`
    ],
    [
        "Grace", `A pretty girl-- blonde haired, blue eyed, full lips. She's 5'10, dressed in a standard uniform or in otherwise preppy attire-- plaid skirts, button ups, blouses, cardigans, always proudly wearing the Prismari house colors of red and blue.. and little else of note, unless it's her work apron. Her hair is sometimes down, sometimes up. She wears simple, clean, natural makeup. Her most remarkable feature is a beauty mark-- above her upper lip, beside her nose. She has a close lipped smile that rarely reaches her eyes-- a tentative movement of her lips paired with wide eyes. Wide, wide eyes-- almost glassy blue, reflecting anything that they behold. 
If you're the sort with a wandering eye that tends to linger, there's always little details about her outfits to be found. Her hair tends to be a little messy, but that's normal, right? Her collar slips, her bras are lacy. She's wearing a black one under white, sometimes her nail polish is chipped. Or there's rips in her stockings, just too many to be one single accident. She wears pigtails, or higher ponies, or mascara that's black instead of blonde, slightly smearing beneath her wide, wide eyes. She stands with her hands behind her back and good posture, most of the time, but sometimes her shoulders hunch into herself and she tucks her arms over her chest.
She seems rather shy. Always hesitant to speak, and she saves her questions for the teachers personally to ask after class. Through work, though, she's perfected her greetings and small talk, which she rolls over to other social situations to get by. She seems sweet enough, but quiet. She can stare for too long before responding, or remembering to smile..`
    ],
    [
    ...
    [
        "Vi", `".. she only got sent to the bog for a week.. ONE week.."

"And she came back with a smile--! The professors don't seriously think that's a punishment for her, right?"

"Ooh--! I heard that when Stacy came back from her suspension, she said someone had hung dead Mephits up in all the trees-- with their INTESTINES pulled out and used to tie them there--!"

"Her fathers are literally notoriously brutal warlords.. on the /Plane of Shadow--/ who even thought it was a good idea to ADMIT her here--? "

"What can you expect--? She kidnapped a student, strapped them down, and ripped their veins out of their arm--! For a PROJECT--! Are you kidding me? She's insane--!"

"The professors won't even do anything, they don't care--! Elias dropped out after that--! And you know what, I don't blame him--! I have a class with her, her project last week was made of blood again-- and I don't even know WHOSE!"

"Oh my god-- SHHH-- she's right there--!"

The silhouette of a girl who almost looks as if she's under a filter of gray. Long black hair that almost clings together like vines or inky black tendrils. She's tall-- 6'4, wearing a simple dress, or a blouse and slacks-- a white underlayer, and a black overlayer. Skin that looks like porcelain, or marble-- stone, without any flush or sign of life. When she turns, her features are carved and equally lifeless. She has square cheekbones, a square jaw, a straight and narrow nose, flat eyebrows. Her lips are slightly turned into a 'smile' at rest-- corners drawn up, but no creases in her skin. Her eyes are hooded, and lidded in a calm gaze-- the slight bloodshot of her scleras being the only sign of any color that isn't gray. Her eyes are black. Not brown, black. Black like voids that don't retain the tiniest glimmer of light. When she sees you, her expression doesn't change. But her eyelids slightly lower, before she looks away. 

She is frequently in detention for her actions, and even when she isn't, she's often at the farthest ends of the Fen that start to toe the line into murkier, boggier territory.

She is often in the lowest wings of Bliss Hall, conversing with her professors, assisting in research, seeking their advice on her projects, or having conversations, but she usually goes dead silent when someone enters the room.

She sometimes makes her way to the Cultivarium when she finds the Fen and the Bog don't suit her that day, inspecting people's projects and observing the fauna inside.. including the students.
`
    ],
    [
    ...
    [
        "Alexis", `Alexis began her tenure at Strixhaven University with well-defined goals and the drive to master her craft. Joining Quandrix was the next step in a carefully composed plan that she’s held for many years. Her ambitions have always included the planes of existence not so far from the Material—those planes that layer but have diverged near unrecognizably given time and independence. The realm of possibility that Quandrix explores would allow her to answer the questions she has about these places in terms of fate and circumstance. In understanding the prime equation that defines life’s rhythm, she may find the truth she seeks.

With her ambition comes a taste for superiority that she satisfies by sharpening her skills. She networks with students and runs a business within the bounds of Professor Jianhua’s Young Entrepreneur’s Club, and outside of that hobby can often be found studying with her friends on Central Campus when she’s not busy at the Stadium practicing with the Mage Tower team.

Alexis has not changed very much since her first year. Back then, she was determined to achieve greatness, and with each passing lesson she learns she becomes closer to realizing her ultimate goals. The air of pride and the feeling that she knows more than she should only grow stronger as she gains more power—and the years have sharpened her wit. However, the knowledge that she’s nearing the end of her Strixhaven days leads her to a more…encouraging dynamic with many of the Quandrix underclassmen. In some strange way, she feels secure enough in her power and passion to pass the torch. 
`
    ],
])